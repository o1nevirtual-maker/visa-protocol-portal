...
const buildUpdateWitness = (value, options) => {
    ...
    return buildCommonTransaction(updateWitnessContract, Transaction.Contract.ContractType.WITNESSUPDATECONTRACT, 'WitnessUpdateContract', options.Permission_id);
};
// vote
