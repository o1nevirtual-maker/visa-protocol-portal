...
export declare class TransactionBuilder {
    ...
    updateWitness(address?: string, url?: string, options?: TransactionCommonOptions): Promise<Transaction<WitnessUpdateContract>>;
