...
// --- ROUTING &amp;amp;amp; ENDPOINTS ---
// Mount the entire logic handler object as middleware, catching /stats and /process
...
const startServer = async () => {
    ...
    try {
        // 1. Connection Validation is the first critical step
        await connectDB(); // This function handles process.exit(1) on failure

        // 2. Start HTTP Server ONLY if DB connected successfully
        app.listen(PORT, () => {
            console.log("\n=============================&amp;gt;");
        ...
        // Catch any setup errors that slip past connectDB's process.exit()
